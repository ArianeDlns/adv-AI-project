...
Another physical attack, developed by Sharif et al. (2016) [5], is the Eyeglass Accessory Printing. It consists of wearing 3D printed paper glasses allowing a targeted attack (see example below where Reese Witherspoon is impersonating Russel Crowe with the glasses).
 
<p align="center"> <img src="https://github.com/ArianeDlns/adv-AI-project/blob/main/img/impersonation_glasses.png" width="500" alt="Impersonating attack with glasses">
